from django.contrib.auth import views as auth_views # for authentication and simple create to login and logout  (learn django authentication document)
...
app_name = 'account' # Because of namespace
...
urlpatterns = [
    ...
    path('password_reset/password_reset_email_confirm/', TemplateView.as_view(template_name="account/password_reset/reset_status.html"), 
                                                                name='password_reset_done'),
    
    path('password_reset_confirm/Mg/password_reset_complete/', TemplateView.as_view(template_name="account/password_reset/reset_status.html"), 
